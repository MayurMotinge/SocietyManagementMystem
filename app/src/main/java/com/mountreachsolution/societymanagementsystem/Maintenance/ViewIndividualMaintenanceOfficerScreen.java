...
import com.mountreachsolution.societymanagementsystem.Admin.Maintenance.AddMaintenanceOfficerScreen;
import com.mountreachsolution.societymanagementsystem.Admin.Maintenance.ViewMaintenanceOfficerAdapter;
import com.mountreachsolution.societymanagementsystem.Admin.Maintenance.pojo_Maintenance_Officer;
...
public class ViewIndividualMaintenanceOfficerScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user_role.equals("maintenance"))
        {
            btn_add_maintenence_officer.setVisibility(View.GONE);
            searchView_maintenence_officer.setVisibility(View.GONE);
        }
        else
        {
            btn_add_maintenence_officer.setVisibility(View.VISIBLE);
            searchView_maintenence_officer.setVisibility(View.VISIBLE);
        }
        btn_add_maintenence_officer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ViewIndividualMaintenanceOfficerScreen.this, AddMaintenanceOfficerScreen.class));
                finish();
            }
        });
    ...
    private void searchmaintenence(String query) {
        ...
        adapter = new ViewMaintenanceOfficerAdapter(tempcenterlist, ViewIndividualMaintenanceOfficerScreen.this, tv_no_record);
        lv_all_maintenence_officer.setAdapter(adapter);
    }

    private void getMaintenanceOfficer() {

        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();

        params.put("username",username);
        client.post(Config.url_view_individual_maintenence_officer, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("getIndividualMaintenanceOfficer");
                    ...
                    adapter = new ViewMaintenanceOfficerAdapter(list, ViewIndividualMaintenanceOfficerScreen.this, tv_no_record);
                    lv_all_maintenence_officer.setAdapter(adapter);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Toast.makeText(ViewIndividualMaintenanceOfficerScreen.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
            }
        });
    }
