package com.mountreachsolution.societymanagementsystem.Admin;
...
public class AdminHomeScreen extends AppCompatActivity {
    ...
    {
        startActivity(new Intent(AdminHomeScreen.this, ViewResidenentScreen.class));
        finish();
    }

    public void card_view22(View view)
    {
        startActivity(new Intent(AdminHomeScreen.this, ViewMaintenanceOfficerScreen.class));
    }

    public void card_view33(View view)
    {
        startActivity(new Intent(AdminHomeScreen.this, ViewNoticeScreen.class));
    }

    public void card_view44(View view)
    {
        startActivity(new Intent(AdminHomeScreen.this, ViewComplaints_FeedbackScreen.class));
        finish();
    }
    ...
    public void logout() {
        ...
        ad.setNegativeButton("Logout", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                editor.putBoolean("adminlogin", false).commit();
